...
//define('APP_RUNNING', true);
require_once dirname(__DIR__, 1) . '/templates/header_admin.php';
require_once dirname(__DIR__, 1) . '/templates/sidebar_admin.php';
        ...
        <div class="row">
            <div class="card shadow-lg">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="encuesta_admin.php" class="btn btn-outline-info btn-sm">⬅ Volver</a>
                </div>
                <div class="card-body">
				<form method="post">
					<div class="mb-3">
...
require_once dirname(__DIR__, 1) . '/templates/footer_admin.php';
?>